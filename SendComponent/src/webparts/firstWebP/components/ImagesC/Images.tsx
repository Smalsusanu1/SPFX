...
export default function ImagesC({id}:any) {
    ...
    const [lets, setlets] = React.useState('/sites/HHHH/PublishingImages/Portraits');
    React.useEffect(() => {
        ...
        let url = `https://hhhhteams.sharepoint.com/sites/HHHH/_api/lists/getbyid('655B3B68-88EC-4F7F-9767-49C18EEDE5D5')/items?$select=Id,Title,Created,FileLeafRef,EncodedAbsUrl,FileDirRef,Modified,Author/Title,Editor/Title&$expand=Author,Editor&$top=4999&$filter=FSObjType%20eq%200&$orderby=Created%20desc`;
      ...
      function Portraits():void{
        setlets("/sites/HHHH/PublishingImages/Portraits");
      }
      function PageI(){
        setlets("/sites/HHHH/PublishingImages/Page-Images");
      }
      function ICONS(){
        setlets("/sites/HHHH/PublishingImages/ICONS");
      }
 const SelectedImagess: any[] = [];
