...
export default function CreateEmployee({arr}:any){
    ...
    const EditData = (e: any, Id: any) => {
        ...
        spRequest.onreadystatechange = function () {
            ...
            if (spRequest.readyState === 4 && spRequest.status === 200) {
                const result = JSON.parse(spRequest.responseText);
    ...
    const LanguagesArray: any = [{ 'Title': 'English' }, { 'Title': 'German' }, { 'Title': 'French' }, { 'Title': 'Spanish' }];
            ...
            .map((item:any) => (
             ...
             {/* onClick={() =><EditEmployeeContact id={item.Id}/> */}
                  ...
                  <div className="modal-footer">
                      <span >
                          <button type="button" className="btn btn-primary mt-10"  onClick={(e) => EmptyPopup(e)}>
                              Save  
                          </button>
                      </span>
            ...
            <div className="col-sm-5 text-left pad0">
                ...
                <div className="text-left">
                    <a className="hreflink" >
                        <img src="/_layouts/images/deconste.gif"/> Deconste this item
                    </a>
                </div>
            </div>
                    ...
                    <Tabs>
                        ...
                        <div className="tab-content clearfix">
                            <div id="basicinfo" className="clearfix">
                                ...
                                <div className="col-lg-12 smartToggler clearfix" >
                            <div className="panel panel-default border-0">
                                <label className="col-lg-12 mb0 pd5 bg-grey full_width" htmlFor="identifiertxt"  >
                                HR Information
                                <a  id="identifiertxt">
