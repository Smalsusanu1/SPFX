...
import * as strings from 'NavbartApplicationCustomizerStrings';
import { Components } from "gd-sprest-bs";

const LOG_SOURCE: string = 'NavbartApplicationCustomizer';
 ...
 */
export interface INavbartApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class NavbartApplicationCustomizer
  extends BaseApplicationCustomizer<INavbartApplicationCustomizerProperties> {
